...
const experiences = [
  {
    ...
    points: [
      ...
      "Worked on 5+ internal applications which are being used widely inside by the utility service provider company.",
...
const testimonials = [
  {
    testimonial:
      "Nishan is highly skilled software engineer with plethora of technical knowledge. He is hard-working, punctual, and has excellent communication skills. He is a good team player, and very friendly person to work with. I wish him very best for his future endeavours.",
    name: "Alivia Modak",
  ...
  {
    testimonial:
      "I have worked with Nishan in TCS Digital internship. We were in same team during our internship ie . BFSI EAST US DIGITAL TEAM. He is hardworking mate . Best wishes to Nishan for future.",
    name: "Arsh Seth",
  ...
  {
    testimonial:
      "Nishan is one of the best among all the people I have ever worked with. I worked with Nishan for 3 years. As I remember, Nishan was a very productive person, is hardworking, broad-minded and forward thinking individual. Intelligent, ambitious, energetic and proactive perfectionist.",
    name: "Jayanta Ghosh",
    designation: "Software Engineer",
    company: "TCS",
...
const projects = [
  {
    ...
    image: carrent,
    source_code_link: "https://github.com/nishan-iicm/Amazon-Clone",
  },
  {
